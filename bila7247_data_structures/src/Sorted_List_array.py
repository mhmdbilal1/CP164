...
class Sorted_List:
    ...
    def __contains__(self, key):
        ...
        ans = False
        index = 0
        while index < len(self._values) and not ans:
    ...
    def clean(self):
        ...
        while index < len(self._values):
            if self._values[index] == self._values[index-1]:
    ...
    def intersection(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        assert len(self._values) == 0, "Target list msut be empty"
        i = 0
        j = 0
    ...
    def __eq__(self, target):
        ...
        if len(self._values) == len(target._values):
            index = 0
            while index < len(self._values) and self._values[index] == target._values[index]:
                index += 1
            equals = index == len(self._values)
        return equals
    ...
    def remove(self, key):
        ...
        for values in self._values:
            if values == key:
                value = self._values.pop(self._values.index(values))
