...
class List:
    ...
    def clean(self):
        ...
        #         if self._values[index] == self._values[j]:
        #             self._values.pop(j)
        #         else:
        #             j += 1
        #     index += 1
    ...
    def intersection(self, source1, source2):
        ...
        """
        for val in source1:
            if val in source2 and val not in self._values:
                self.append(val)
